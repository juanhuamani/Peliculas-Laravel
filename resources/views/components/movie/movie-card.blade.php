      ...
      <div class="bg-white shadow-lg border-gray-100 max-h-72	 border sm:rounded-3xl p-3 flex space-x-8">
        ...
        <div class="flex flex-col w-1/2 space-y-4">
          ...
          <div>
            ...
            @endforeach
            <a href="/movies/{{$movie['id']}}" type="button" class="mt-6 inline-block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">More info</a>
          </div>
        </div>
